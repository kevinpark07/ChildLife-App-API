...
vol2 = Volunteer.create!(name: "Jack Scordato", age: 23, email: "jscordato12@gmail.com", password: "1234", approved: false, profile_image: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80.jpg")
vol3 = Volunteer.create!(name: "Natalie Rosen", age: 18, email: "nrosen01@gmail.com", password: "1234", approved: false, profile_image: "https://images.unsplash.com/photo-1567131308618-79aa79b33cdd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60.jpg")
...
int2 = Interview.create!(date: "2020-17-11", time: "15:30", notes: "", volunteer: vol2, administrator: admin1)
int3 = Interview.create!(date: "2020-19-11", time: "13:00", notes: "", volunteer: vol3, administrator: admin1)
